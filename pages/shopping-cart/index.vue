    ...
    <div class="out_block w-full">
      ...
      <div class="shopping_cart_list hidden lg:block">
        <div
          ...
          :class="{ is_selected_product: eachProduct.isSelected }"
        >
          <div class="product_checkbox_pc flex grow basis-0 items-center justify-center">
          ...
          <div class="product_single_price flex grow basis-0 items-center justify-center">
            <span>NT$</span>
          ...
          <div class="product_total_price flex grow basis-0 items-center justify-center">
