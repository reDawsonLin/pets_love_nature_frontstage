...
//   取得整理過後的購物車
  const getTransformCartArray = async () => {
    ...
    const addCartNoLogin = (cartArr, addWay) => {
      ...
      console.log('sessionStorageRRR1',sessionStorage.getItem('shoppingCartNoLogin'));
  ...
  return { cartArr, threeCart , getTransformCartArray, addCart, deleteCart, addTestCartNoLogin, loginAddCart };
});
